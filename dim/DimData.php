...
class DimData{
    ...
    public function extrairETransformarDatas(){
        ...
        try{
         ...
         if($resultDimData->num_rows == 0){ //dimensao vazia
    ...
    public function carregarNovaData($objData){
        ...
        $sqlInsertData->bind_param('ssssssss', $objData->data, $objData->mes, $objData->ano, $objData->semana_ano, $objData->bimestre, $objData->semestre, $objData->trimestre);
